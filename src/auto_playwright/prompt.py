...
SYSTEM_PROMPT = """You must interact with the page using a set of functions.
...
def prompt(message: TaskMessage) -> str:
    """
    The prompt itself is very simple because the vast majority of the logic is derived from
    the instructions contained in the parameter and function descriptions provided to openai.
    """
    return f"""This is your task: {message['task']}
